...
def get_combined_data():
    # reading train data
    train = pd.read_csv('C:\\Users\\bjzhaochen\Desktop\kaggle\\train.csv')
    # reading test data
    test = pd.read_csv('C:\\Users\\bjzhaochen\Desktop\kaggle\\test.csv')
...
def recover_train_test_target():
    ...
    train0 = pd.read_csv('C:\\Users\\bjzhaochen\Desktop\kaggle\\train.csv')
